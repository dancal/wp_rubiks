...
square_size_factor=0.5 #fraction of height of image that square occupies
square_x1=int((width-((square_size_factor)*height))/2) - 100 #coordinate calculation for square corners
